                ...
                if (argv[argc].equals("-b")) {
                    ...
                    if (mNumberOfBeings < 1
                        ...
                        Utils.showToast(context,
                                String.format(
                                        context.getString(
                                                R.string.toast_cmdline_max_beings_hint),
                                        MAX_BEINGS));
                        return false;
                    }
                    ...
                    if (mGazingIterations < 1
                        ...
                        Utils.showToast(context,
                                String.format(context.getString(
                                        R.string.toast_cmdline_max_iterations_hint),
                                                MAX_BEINGS));
                        return false;
                    }
                    ...
                    if (mLeaseDuration < 1000
                        ...
                        Utils.showToast(context,
                                String.format(context.getString(
                                        R.string.toast_cmdline_max_duration_hint),
                                              MAX_DURATION));
                        return false;
                    }
                    ...
                    if (mNumberOfPalantiri < 1 
                        ...
                        Utils.showToast(context,
                                String.format(context.getString(
                                        R.string.toast_cmdline_max_palantiri_hint),
                                                MAX_PALANTIRI));
                        return false;
                    }
                } else 
