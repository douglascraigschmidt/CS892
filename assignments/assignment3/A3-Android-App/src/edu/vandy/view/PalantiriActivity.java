...
public class PalantiriActivity 
     ...
     * lease duration, and gazing iterations that we're simulating.
     */
    private EditText mPalantirEditText;
    private EditText mBeingEditText;
    private EditText mLeaseDurationEditText;
    ...
    private void initializeViews() {
        ...
        mLeaseDurationEditText =
            (EditText) findViewById(R.id.edittext_lease_duration);
