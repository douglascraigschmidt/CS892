...
public interface MVP {
    ...
    public interface RequiredViewOps
         ...
         * dot purple).
         */ 
        void markInterrupted(final int index);
         ...
         */
        void exceptionThrown(int numberOfSimulationThreads);
    ...
    public interface ProvidedPresenterOps
         ...
         */
        void setFairColor(Drawable fairColor);

        /**
         * Get the fair color, which is either green or yellow.
         */
        Drawable getFairColor();
         ...
         * application.
         */
        ProvidedModelOps getModel();
    }

    /**
     * This interface allows the Model layer to call methods in the
     * Presenter layer without knowing any implementation details.
     */
    public interface RequiredPresenterOps 
         ...
         * the PalantiriManager.  It then creates a Thread for each
         * Being and has each Being attempt to acquire a Palantir for
         * gazing, mediated by the PalantiriManager.  The BeingTheads
         * call methods from the MVP.RequiredViewOps interface to
         * visualize what is happening to the user.
         */
        void start();
    }
    ...
    public interface ProvidedModelOps 
         ...
         */
        Palantir acquirePalantir(long leaseDurationInMillis);
         ...
         */
        long remainingTime(Palantir palantir);
    }
}
