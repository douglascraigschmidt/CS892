...
public class GazingSimulationActivity
    ...
    private final static String DEFAULT_SEMAPHORE = "java";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initializeSimulation(getPresenter().configurationChangeOccurred());

        // Note that the presenter().start() method is called back
        // within the Model layer so the BeingThreads don't start
        // gazing until after the PalantiriService is connected.
    }
    ...
    /**
     * Initialize the simulation based on the current conditions.
     */
    private void initializeSimulation(boolean configurationChangeOccurred) {
        ...
        if (configurationChangeOccurred == true
            ...
            // The button should say "Stop Simulation."
    ...
    public void simulationButtonPressed(View v) { 
        if (getPresenter().isRunning()) 
            ...
            // Re-start the simulation in the Presenter layer.
            getPresenter().start();
        }
    }
