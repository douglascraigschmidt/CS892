...
public class GenericServiceConnection<AIDLInterface extends 
     ...
     *
     * @param aidl 
     *          The AIDL Interface class object that must match
     *          the generic parameter.
     * @param connectedCallback
     *          A Runnable whose run() hook method is invoked when
     *          the Service is connected.
     */
    public GenericServiceConnection(final Class<AIDLInterface> aidl,
                                    Runnable connectedCallback) {
        mCallback = connectedCallback;
        Class<?> stub = null;
        Method method = null;
    ...
    public void onServiceConnected(ComponentName name,
                                   IBinder service) {
        Log.d("GenericServiceConnection", 
              "Connected to ComponentName " 
              + name);
        try {
            mInterface =
                (AIDLInterface) mAsInterface.invoke(mStub,
                                                    new Object[]{service});
            if (mCallback != null)
                mCallback.run();
