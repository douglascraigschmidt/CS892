...
/**
 * @class DotArrayAdapter
 *
 * @brief An ArrayAdapter that takes list of Color enums and adapts it to a
 *        ListView so that the list appears as a series of green, yellow, or red
 *        dots.
 * 
 *        The supplied layout for inflation must contain an ImageView with the
 *        id "dot".
 */
public class DotArrayAdapter extends ArrayAdapter<DotColor> {
    /**
    ...
    /**
     * The list of boolean values that we will be representing as red
     * or green dots in our ListView
     */
    List<DotColor> mDots;

    /**
     * The constructor for our adapter. Takes a context to retrieve
     * the resources from, which resource to instantiate, and the list
     * of objects we will be displaying as a list in the GUI.
     */
    public DotArrayAdapter(Context context,
                           int textViewResourceId,
                           List<DotColor> objects) {
    ...
    public View getView(int position,
                        View convertView,
                        ViewGroup parent) {
        DotColor item = getItem(position);
